...
#ifndef __AI8051U_PWM_H
#define __AI8051U_PWM_H     
...
#define        PWM1_USE_P00P01()        PWMA_PS = (PWMA_PS & ~0x03) | 0x01     /* PWM 通道 1 输出脚切换到P00(PWM1P) P01(PWM1N) */
#define        PWM1_USE_P20P21()        PWMA_PS = (PWMA_PS & ~0x03) | 0x02     /* PWM 通道 1 输出脚切换到P20(PWM1P) P21(PWM1N */

#define        PWM2_USE_P12P13()        PWMA_PS = (PWMA_PS & ~0x0C)            /* PWM 通道 2 输出脚切换到P12/P54(PWM2P) P13(PWM2N) */
#define        PWM2_USE_P02P03()        PWMA_PS = (PWMA_PS & ~0x0C) | 0x04     /* PWM 通道 2 输出脚切换到P02(PWM2P) P03(PWM2N) */
#define        PWM2_USE_P22P23()        PWMA_PS = (PWMA_PS & ~0x0C) | 0x08     /* PWM 通道 2 输出脚切换到P22(PWM2P) P23(PWM2N) */

#define        PWM3_USE_P14P15()        PWMA_PS = (PWMA_PS & ~0x30)            /* PWM 通道 3 输出脚切换到P14(PWM3P) P15(PWM3N) */
#define        PWM3_USE_P04P05()        PWMA_PS = (PWMA_PS & ~0x30) | 0x10     /* PWM 通道 3 输出脚切换到P04(PWM3P) P05(PWM3N) */
#define        PWM3_USE_P24P25()        PWMA_PS = (PWMA_PS & ~0x30) | 0x20     /* PWM 通道 3 输出脚切换到P24(PWM3P) P25(PWM3N) */

#define        PWM4_USE_P16P17()        PWMA_PS = (PWMA_PS & ~0xC0)            /* PWM 通道 4 输出脚切换到P16(PWM4P) P17(PWM4N) */
#define        PWM4_USE_P06P07()        PWMA_PS = (PWMA_PS & ~0xC0) | 0x40     /* PWM 通道 4 输出脚切换到P06(PWM4P) P07(PWM4N) */
#define        PWM4_USE_P26P27()        PWMA_PS = (PWMA_PS & ~0xC0) | 0x80     /* PWM 通道 4 输出脚切换到P26(PWM4P) P27(PWM4N) */

#define        PWM5_USE_P01()            PWMB_PS = (PWMB_PS & ~0x03)            /* PWM 通道 5 输出脚切换到P01(PWM5) */
#define        PWM5_USE_P11()            PWMB_PS = (PWMB_PS & ~0x03) | 0x01     /* PWM 通道 5 输出脚切换到P11(PWM5) */
#define        PWM5_USE_P21()            PWMB_PS = (PWMB_PS & ~0x03) | 0x02     /* PWM 通道 5 输出脚切换到P21(PWM5) */
#define        PWM5_USE_P50()            PWMB_PS = (PWMB_PS | 0x03)             /* PWM 通道 5 输出脚切换到P50(PWM5) */

#define        PWM6_USE_P03()            PWMB_PS = (PWMB_PS & ~0x0C)            /* PWM 通道 6 输出脚切换到P01(PWM6) */
#define        PWM6_USE_P13()            PWMB_PS = (PWMB_PS & ~0x0C) | 0x04     /* PWM 通道 6 输出脚切换到P11(PWM6) */
#define        PWM6_USE_P23()            PWMB_PS = (PWMB_PS & ~0x0C) | 0x08     /* PWM 通道 6 输出脚切换到P21(PWM6) */
#define        PWM6_USE_P51()            PWMB_PS = (PWMB_PS | 0x0C)             /* PWM 通道 6 输出脚切换到P50(PWM6) */

#define        PWM7_USE_P05()            PWMB_PS = (PWMB_PS & ~0x30)            /* PWM 通道 7 输出脚切换到P05(PWM7) */
#define        PWM7_USE_P15()            PWMB_PS = (PWMB_PS & ~0x30) | 0x10     /* PWM 通道 7 输出脚切换到P15(PWM7) */
#define        PWM7_USE_P25()            PWMB_PS = (PWMB_PS & ~0x30) | 0x20     /* PWM 通道 7 输出脚切换到P25(PWM7) */
#define        PWM7_USE_P52()            PWMB_PS = (PWMB_PS | 0x30)             /* PWM 通道 7 输出脚切换到P52(PWM7) */

#define        PWM8_USE_P07()            PWMB_PS = (PWMB_PS & ~0xC0)            /* PWM 通道 8 输出脚切换到P07(PWM8) */
#define        PWM8_USE_P17()            PWMB_PS = (PWMB_PS & ~0xC0) | 0x40     /* PWM 通道 8 输出脚切换到P17(PWM8) */
#define        PWM8_USE_P27()            PWMB_PS = (PWMB_PS & ~0xC0) | 0x80     /* PWM 通道 8 输出脚切换到P27(PWM8) */
#define        PWM8_USE_P53()            PWMB_PS = (PWMB_PS | 0xC0)             /* PWM 通道 8 输出脚切换到P53(PWM8) */
