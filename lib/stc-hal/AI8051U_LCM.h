...
#ifndef	__AI8051U_LCM_H
#define	__AI8051U_LCM_H
...
__sbit __at(0xC5) LCD_RS;         //数据/命令切换
__sbit __at(0xB6) LCD_WR;         //写控制
__sbit __at(0xB7) LCD_RD;         //读控制
__sbit __at(0x85) LCD_CS;         //片选
__sbit __at(0xC7) LCD_RESET;      //复位
