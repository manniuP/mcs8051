...
#define 	ADC_PowerOn(n)			(n==0?(ADC_CONTR = (unsigned char)((ADC_CONTR & ~0x80) | ((0) ? 0x80 : 0))):(ADC_CONTR = (unsigned char)((ADC_CONTR & ~0x80) | ((1) ? 0x80 : 0))))	/* ADC电源开关 */
#define 	ADC_Justify(n)			(n==0?(ADCCFG = (unsigned char)((ADCCFG & ~0x20) | ((0) ? 0x20 : 0))):(ADCCFG = (unsigned char)((ADCCFG & ~0x20) | ((1) ? 0x20 : 0))))				/* ADC转换结果格式控制, 左对齐/右对齐 */
