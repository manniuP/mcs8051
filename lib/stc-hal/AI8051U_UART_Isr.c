...
__bit B_ULinRX1_Flag;
__bit B_ULinRX2_Flag;
...
//========================================================================
#ifdef UART1
void UART1_ISR_Handler (void) __interrupt(UART1_VECTOR)
{
    u8 Status;
...
//========================================================================
#ifdef UART2
void UART2_ISR_Handler (void) __interrupt(UART2_VECTOR)
{
    u8 Status;
...
//========================================================================
#ifdef UART3
void UART3_ISR_Handler (void) __interrupt(UART3_VECTOR)
{
    if((S3CON & 0x01))
    {
        CLR_RI3();
...
//========================================================================
#ifdef UART4
void UART4_ISR_Handler (void) __interrupt(UART4_VECTOR)
{
    if((S4CON & 0x01))
    {
        CLR_RI4();
