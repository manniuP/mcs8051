...
xmake build usbhid            # -> build\examples\ai8051u\usb_hid\usb_hid.ihx（链到 0xff0000）
```
...
```powershell
powershell -File examples\ai8051u\usb_hid\hidread.ps1 -Vid 0x34BF -ProductId 0xFF01 -Seconds 5
