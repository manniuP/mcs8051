...
xmake build usbcdc            # -> build\examples\ai8051u\usb_cdc\usb_cdc.ihx（链到 0xff0000）
```
...
& $bin\sdar.exe -rc examples\ai8051u\usb_cdc\usb_cdc_sdcc.lib `
    build\examples\ai8051u\usb_cdc\usb.rel build\examples\ai8051u\usb_cdc\usb_desc.rel `
    build\examples\ai8051u\usb_cdc\usb_req_std.rel build\examples\ai8051u\usb_cdc\usb_req_class.rel `
    build\examples\ai8051u\usb_cdc\usb_req_vendor.rel build\examples\ai8051u\usb_cdc\util.rel
& $bin\sdranlib.exe examples\ai8051u\usb_cdc\usb_cdc_sdcc.lib
