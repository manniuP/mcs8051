 ...
 * 主机用 examples/ai8051u_zig_log/decode.ps1（-Port <CDC口>）解码。
 *
 * 单编译单元：SDCC（mcs251）只在**定义了 main 的模块**里生成中断向量表，
 * 故把 usb_isr/uart2_isr 所在模块（uart.c/usb.c/...）全部 #include 进来；
 * 这些源码在 ../ai8051u_usb_cdc/src/，用 `-I` 指向其目录即可解析其头文件。
 *
...
#include "../ai8051u_usb_cdc/src/uart.c"
#include "../ai8051u_usb_cdc/src/usb.c"
#include "../ai8051u_usb_cdc/src/usb_desc.c"
#include "../ai8051u_usb_cdc/src/usb_req_std.c"
#include "../ai8051u_usb_cdc/src/usb_req_class.c"
#include "../ai8051u_usb_cdc/src/usb_req_vendor.c"
#include "../ai8051u_usb_cdc/src/util.c"
