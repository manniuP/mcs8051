...
xmake build zigslice       # 产物 examples/ai8051u_zig_slice/slice.ihx
```
...
```bash
wsl -e bash /mnt/e/code/yuyan/mcs251/tools/qemu_mcs_run.sh \
  /mnt/e/code/yuyan/mcs251/examples/ai8051u_zig_slice/slice.ihx
```
