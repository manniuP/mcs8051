...
;------------------------------------------------------------
;	<workspace>\mcs251\lib\cobs\cobs.c:8: static void cobs_patch(cobs_enc_t *e) {
;	-----------------------------------------
;	 function cobs_patch
;	-----------------------------------------
_cobs_patch:
	...
	mov	@dpx,a
;	<workspace>\mcs251\lib\cobs\cobs.c:9: if (e->code_pos < e->len) e->buf[e->code_pos] = e->code;
	mov	dptr,#(_cobs_patch_e_10000_15 + 2)
	mov	dpxl,#((_cobs_patch_e_10000_15 + 2) >> 16)
	mov	a,@dpx
	mov	r7,a
...
00112$:
	...
	ecall	__gptrput
00103$:
;	<workspace>\mcs251\lib\cobs\cobs.c:10: }
	eret
;------------------------------------------------------------
...
;------------------------------------------------------------
;	<workspace>\mcs251\lib\cobs\cobs.c:12: static void cobs_begin_block(cobs_enc_t *e, unsigned char code) {
;	-----------------------------------------
...
_cobs_begin_block:
	...
	mov	@dpx,a
;	<workspace>\mcs251\lib\cobs\cobs.c:13: if (e->len >= e->cap) {
	mov	dptr,#(_cobs_begin_block_e_10000_18 + 2)
	mov	dpxl,#((_cobs_begin_block_e_10000_18 + 2) >> 16)
	mov	a,@dpx
	mov	r7,a
	...
	ejmp	00102$
00112$:
;	<workspace>\mcs251\lib\cobs\cobs.c:14: e->overflow = 1;
	mov	a,#0x0b
	add	a,r7
	mov	r4,a
	clr	a
	...
	mov	a,#0x01
	ecall	__gptrput
;	<workspace>\mcs251\lib\cobs\cobs.c:15: return;
	ejmp	00103$
00102$:
;	<workspace>\mcs251\lib\cobs\cobs.c:17: e->code_pos = e->len;
	mov	a,#0x07
	add	a,r7
	mov	r4,a
	clr	a
	...
	mov	a,r15
	ecall	__gptrput
;	<workspace>\mcs251\lib\cobs\cobs.c:18: e->buf[e->len] = 0; /* 长度码占位 */
	mov	ar4,r7
	mov	ar3,r6
	mov	ar2,r5
	mov	dpl,r4
	...
	clr	a
	ecall	__gptrput
;	<workspace>\mcs251\lib\cobs\cobs.c:19: e->len++;
	mov	dptr,#(_cobs_begin_block_sloc1_1_0 + 2)
	mov	dpxl,#((_cobs_begin_block_sloc1_1_0 + 2) >> 16)
	mov	a,@dpx
	push	acc
...
00113$:
	...
	mov	a,r2
	ecall	__gptrput
;	<workspace>\mcs251\lib\cobs\cobs.c:20: e->code = code;
	mov	a,#0x09
	add	a,r7
	mov	r7,a
	clr	a
	...
	ecall	__gptrput
00103$:
;	<workspace>\mcs251\lib\cobs\cobs.c:21: }
	eret
;------------------------------------------------------------
...
;------------------------------------------------------------
;	<workspace>\mcs251\lib\cobs\cobs.c:23: void cobs_init(cobs_enc_t *e, unsigned char *buf, unsigned int cap) {
;	-----------------------------------------
;	 function cobs_init
;	-----------------------------------------
_cobs_init:
	...
	mov	@dpx,a
;	<workspace>\mcs251\lib\cobs\cobs.c:24: e->buf = buf;
	mov	dptr,#(_cobs_init_e_10000_22 + 2)
	mov	dpxl,#((_cobs_init_e_10000_22 + 2) >> 16)
	mov	a,@dpx
	mov	r7,a
	...
	mov	a,r4
	ecall	__gptrput
;	<workspace>\mcs251\lib\cobs\cobs.c:25: e->cap = cap;
	mov	a,#0x03
	add	a,r7
	mov	r4,a
	clr	a
	...
	mov	a,r15
	ecall	__gptrput
;	<workspace>\mcs251\lib\cobs\cobs.c:26: cobs_reset(e);
	mov	dpl, r7
	mov	dph, r6
	mov	b, r5
;	<workspace>\mcs251\lib\cobs\cobs.c:27: }
	ejmp	_cobs_reset
;------------------------------------------------------------
...
;------------------------------------------------------------
;	<workspace>\mcs251\lib\cobs\cobs.c:29: void cobs_reset(cobs_enc_t *e) {
;	-----------------------------------------
;	 function cobs_reset
;	-----------------------------------------
_cobs_reset:
	...
	mov	@dpx,a
;	<workspace>\mcs251\lib\cobs\cobs.c:30: e->len = 0;
	mov	dptr,#(_cobs_reset_e_10000_24 + 2)
	mov	dpxl,#((_cobs_reset_e_10000_24 + 2) >> 16)
	mov	a,@dpx
	mov	r7,a
	...
	clr	a
	ecall	__gptrput
;	<workspace>\mcs251\lib\cobs\cobs.c:31: e->code = 1;
	mov	a,#0x09
	add	a,r7
	mov	r4,a
	clr	a
	...
	mov	a,#0x01
	ecall	__gptrput
;	<workspace>\mcs251\lib\cobs\cobs.c:32: e->code_pos = 0;
	mov	a,#0x07
	add	a,r7
	mov	r4,a
	clr	a
	...
	clr	a
	ecall	__gptrput
;	<workspace>\mcs251\lib\cobs\cobs.c:33: e->ck = 0;
	mov	a,#0x0a
	add	a,r7
	mov	r4,a
	clr	a
	...
	clr	a
	ecall	__gptrput
;	<workspace>\mcs251\lib\cobs\cobs.c:34: e->overflow = 0;
	mov	a,#0x0b
	add	a,r7
	...
	clr	a
	ecall	__gptrput
;	<workspace>\mcs251\lib\cobs\cobs.c:35: if (e->cap == 0) {
	mov	a,#0x03
	add	a,r7
	mov	r4,a
	clr	a
	...
	ejmp	00102$
00112$:
;	<workspace>\mcs251\lib\cobs\cobs.c:36: e->overflow = 1;
	mov	dptr,#(_cobs_reset_sloc1_1_0 + 2)
	mov	dpxl,#((_cobs_reset_sloc1_1_0 + 2) >> 16)
	mov	a,@dpx
	push	acc
	...
	mov	a,#0x01
	ecall	__gptrput
;	<workspace>\mcs251\lib\cobs\cobs.c:37: return;
	ejmp	00103$
00102$:
;	<workspace>\mcs251\lib\cobs\cobs.c:39: e->buf[0] = 0; /* 首个块长度码占位 */
	mov	dpl,r7
	mov	dph,r6
	mov	dpxl,r5
	mov	dr28,dpx
	...
	clr	a
	ecall	__gptrput
;	<workspace>\mcs251\lib\cobs\cobs.c:40: e->len = 1;
	mov	dptr,#(_cobs_reset_sloc0_1_0 + 2)
	mov	dpxl,#((_cobs_reset_sloc0_1_0 + 2) >> 16)
	mov	a,@dpx
	push	acc
	...
	ecall	__gptrput
00103$:
;	<workspace>\mcs251\lib\cobs\cobs.c:41: }
	eret
;------------------------------------------------------------
...
;------------------------------------------------------------
;	<workspace>\mcs251\lib\cobs\cobs.c:43: void cobs_putc(cobs_enc_t *e, unsigned char b) {
;	-----------------------------------------
;	 function cobs_putc
;	-----------------------------------------
_cobs_putc:
	...
	mov	@dpx,a
;	<workspace>\mcs251\lib\cobs\cobs.c:44: if (b == 0) {
	...
	ejmp	00102$
00130$:
;	<workspace>\mcs251\lib\cobs\cobs.c:45: cobs_patch(e);
	mov	dptr,#(_cobs_putc_e_10000_28 + 2)
	mov	dpxl,#((_cobs_putc_e_10000_28 + 2) >> 16)
	mov	a,@dpx
	mov	r6,a
	...
	mov	b, r4
	ecall	_cobs_patch
;	<workspace>\mcs251\lib\cobs\cobs.c:46: cobs_begin_block(e, 1);
	mov	dptr,#(_cobs_putc_e_10000_28 + 2)
	mov	dpxl,#((_cobs_putc_e_10000_28 + 2) >> 16)
	mov	a,@dpx
	mov	r6,a
...
;	<workspace>\mcs251\lib\cobs\cobs.c:47: return;
	ejmp	00107$
00102$:
;	<workspace>\mcs251\lib\cobs\cobs.c:49: if (e->code == 255) {
	mov	dptr,#(_cobs_putc_e_10000_28 + 2)
	mov	dpxl,#((_cobs_putc_e_10000_28 + 2) >> 16)
	mov	a,@dpx
	mov	r6,a
...
00131$:
	ejmp	00104$
00132$:
;	<workspace>\mcs251\lib\cobs\cobs.c:50: cobs_patch(e);
	mov	dpl, r6
	mov	dph, r5
	mov	b, r4
	push	ar6
	...
	ecall	_cobs_patch
	pop	r13
;	<workspace>\mcs251\lib\cobs\cobs.c:51: cobs_begin_block(e, 1);
	mov	dptr,#(_cobs_putc_e_10000_28 + 2)
	mov	dpxl,#((_cobs_putc_e_10000_28 + 2) >> 16)
	mov	a,@dpx
	mov	r3,a
	...
	pop	ar6
00104$:
;	<workspace>\mcs251\lib\cobs\cobs.c:53: if (e->len >= e->cap) {
	mov	a,#0x05
	add	a,r6
	mov	r3,a
	clr	a
	...
	ejmp	00106$
00133$:
;	<workspace>\mcs251\lib\cobs\cobs.c:54: e->overflow = 1;
	mov	dptr,#(_cobs_putc_e_10000_28 + 2)
	mov	dpxl,#((_cobs_putc_e_10000_28 + 2) >> 16)
	mov	a,@dpx
	mov	r6,a
	...
	mov	a,#0x01
	ecall	__gptrput
;	<workspace>\mcs251\lib\cobs\cobs.c:55: return;
	ejmp	00107$
00106$:
;	<workspace>\mcs251\lib\cobs\cobs.c:57: e->buf[e->len] = b;
	mov	dptr,#(_cobs_putc_e_10000_28 + 2)
	mov	dpxl,#((_cobs_putc_e_10000_28 + 2) >> 16)
	mov	a,@dpx
	mov	r6,a
	...
	mov	a,r13
	ecall	__gptrput
;	<workspace>\mcs251\lib\cobs\cobs.c:58: e->len++;
	mov	dptr,#(_cobs_putc_sloc2_1_0 + 2)
	mov	dpxl,#((_cobs_putc_sloc2_1_0 + 2) >> 16)
	mov	a,@dpx
	push	acc
...
00134$:
	...
	mov	a,r2
	ecall	__gptrput
;	<workspace>\mcs251\lib\cobs\cobs.c:59: e->code++;
	mov	a,#0x09
	add	a,r6
	mov	r6,a
	clr	a
	...
	ecall	__gptrput
00107$:
;	<workspace>\mcs251\lib\cobs\cobs.c:60: }
	eret
;------------------------------------------------------------
...
;------------------------------------------------------------
;	<workspace>\mcs251\lib\cobs\cobs.c:62: unsigned int cobs_finish(cobs_enc_t *e) {
;	-----------------------------------------
...
_cobs_finish:
	...
	mov	@dpx,a
;	<workspace>\mcs251\lib\cobs\cobs.c:63: cobs_patch(e);
	mov	dptr,#(_cobs_finish_e_10000_36 + 2)
	mov	dpxl,#((_cobs_finish_e_10000_36 + 2) >> 16)
	mov	a,@dpx
	mov	r7,a
	...
	mov	b, r5
	ecall	_cobs_patch
;	<workspace>\mcs251\lib\cobs\cobs.c:64: if (e->len >= e->cap) {
	mov	dptr,#(_cobs_finish_e_10000_36 + 2)
	mov	dpxl,#((_cobs_finish_e_10000_36 + 2) >> 16)
	mov	a,@dpx
	mov	r7,a
	...
	ejmp	00102$
00121$:
;	<workspace>\mcs251\lib\cobs\cobs.c:65: e->overflow = 1;
	mov	a,#0x0b
	add	a,r7
	mov	r4,a
	clr	a
	...
	mov	a,#0x01
	ecall	__gptrput
;	<workspace>\mcs251\lib\cobs\cobs.c:66: return 0;
	mov	dptr,#0x0000
	ejmp	00103$
00102$:
;	<workspace>\mcs251\lib\cobs\cobs.c:68: e->buf[e->len] = 0x00; /* 帧定界 */
	mov	ar4,r7
	mov	ar3,r6
	mov	ar2,r5
	mov	dpl,r4
	...
	clr	a
	ecall	__gptrput
;	<workspace>\mcs251\lib\cobs\cobs.c:69: e->len++;
	mov	dptr,#(_cobs_finish_sloc1_1_0 + 2)
	mov	dpxl,#((_cobs_finish_sloc1_1_0 + 2) >> 16)
	mov	a,@dpx
	push	acc
...
00122$:
	...
	mov	a,r2
	ecall	__gptrput
;	<workspace>\mcs251\lib\cobs\cobs.c:70: return e->overflow ? 0 : e->len;
	mov	a,#0x0b
	add	a,r7
	mov	r7,a
	clr	a
...
00106$:
	...
	mov	dph, r6
00103$:
;	<workspace>\mcs251\lib\cobs\cobs.c:71: }
	eret
;------------------------------------------------------------
...
;------------------------------------------------------------
;	<workspace>\mcs251\lib\cobs\cobs.c:73: unsigned int cobs_encode(const unsigned char *in, unsigned int in_len,
;	-----------------------------------------
...
_cobs_encode:
	...
	mov	@dpx,a
;	<workspace>\mcs251\lib\cobs\cobs.c:77: cobs_init(&e, out, out_cap);
	...
	ecall	_cobs_init
;	<workspace>\mcs251\lib\cobs\cobs.c:78: for (i = 0; i < in_len; i++) cobs_putc(&e, in[i]);
	mov	dptr,#(_cobs_encode_in_10000_40 + 2)
	mov	dpxl,#((_cobs_encode_in_10000_40 + 2) >> 16)
	mov	a,@dpx
	mov	r7,a
...
00123$:
	ejmp	00103$
00101$:
;	<workspace>\mcs251\lib\cobs\cobs.c:79: return cobs_finish(&e);
	mov	dptr,#_cobs_encode_e_10000_41
	mov	b, #(_cobs_encode_e_10000_41 >> 16)
;	<workspace>\mcs251\lib\cobs\cobs.c:80: }
	ejmp	_cobs_finish
;------------------------------------------------------------
...
;------------------------------------------------------------
;	<workspace>\mcs251\lib\cobs\cobs.c:84: void cobs_log_begin(cobs_enc_t *e, unsigned int id) {
;	-----------------------------------------
...
_cobs_log_begin:
	...
	mov	@dpx,a
;	<workspace>\mcs251\lib\cobs\cobs.c:85: unsigned char il = (unsigned char)(id & 0xff);
	...
	mov	r6,a
	mov	ar5,r7
;	<workspace>\mcs251\lib\cobs\cobs.c:86: unsigned char ih = (unsigned char)((id >> 8) & 0xff);
	mov	ar7,r6
;	<workspace>\mcs251\lib\cobs\cobs.c:87: cobs_reset(e);
	mov	dptr,#(_cobs_log_begin_e_10000_43 + 2)
	mov	dpxl,#((_cobs_log_begin_e_10000_43 + 2) >> 16)
	mov	a,@dpx
	mov	r6,a
	...
	push	ar5
	ecall	_cobs_reset
;	<workspace>\mcs251\lib\cobs\cobs.c:88: cobs_putc(e, 0x7e);
	mov	dptr,#(_cobs_log_begin_e_10000_43 + 2)
	mov	dpxl,#((_cobs_log_begin_e_10000_43 + 2) >> 16)
	mov	a,@dpx
	mov	r6,a
	...
	ecall	_cobs_putc
	pop	ar5
;	<workspace>\mcs251\lib\cobs\cobs.c:89: cobs_putc(e, il);
	mov	dptr,#(_cobs_log_begin_e_10000_43 + 2)
	mov	dpxl,#((_cobs_log_begin_e_10000_43 + 2) >> 16)
	mov	a,@dpx
	mov	r6,a
	...
	pop	ar5
	pop	ar7
;	<workspace>\mcs251\lib\cobs\cobs.c:90: cobs_putc(e, ih);
	mov	dptr,#(_cobs_log_begin_e_10000_43 + 2)
	mov	dpxl,#((_cobs_log_begin_e_10000_43 + 2) >> 16)
	mov	a,@dpx
	mov	r6,a
	...
	pop	ar5
	pop	ar7
;	<workspace>\mcs251\lib\cobs\cobs.c:91: e->ck = il ^ ih;
	mov	dptr,#(_cobs_log_begin_e_10000_43 + 2)
	mov	dpxl,#((_cobs_log_begin_e_10000_43 + 2) >> 16)
	mov	a,@dpx
	mov	r6,a
	...
	mov	dr28,dpx
	mov	a,r7
;	<workspace>\mcs251\lib\cobs\cobs.c:92: }
	ejmp	__gptrput
;------------------------------------------------------------
...
;------------------------------------------------------------
;	<workspace>\mcs251\lib\cobs\cobs.c:94: void cobs_log_raw(cobs_enc_t *e, unsigned char b) {
;	-----------------------------------------
...
_cobs_log_raw:
	...
	mov	@dpx,a
;	<workspace>\mcs251\lib\cobs\cobs.c:95: cobs_putc(e, b);
	mov	dptr,#(_cobs_log_raw_e_10000_45 + 2)
	mov	dpxl,#((_cobs_log_raw_e_10000_45 + 2) >> 16)
	mov	a,@dpx
	mov	r7,a
	...
	ecall	_cobs_putc
	pop	ar4
;	<workspace>\mcs251\lib\cobs\cobs.c:96: e->ck ^= b;
	mov	dptr,#(_cobs_log_raw_e_10000_45 + 2)
	mov	dpxl,#((_cobs_log_raw_e_10000_45 + 2) >> 16)
	mov	a,@dpx
	mov	r7,a
	...
	mov	dr28,dpx
	mov	a,r4
;	<workspace>\mcs251\lib\cobs\cobs.c:97: }
	ejmp	__gptrput
;------------------------------------------------------------
...
;------------------------------------------------------------
;	<workspace>\mcs251\lib\cobs\cobs.c:99: void cobs_log_u8(cobs_enc_t *e, unsigned char v) {
;	-----------------------------------------
...
_cobs_log_u8:
	...
	mov	@dpx,a
;	<workspace>\mcs251\lib\cobs\cobs.c:100: cobs_log_raw(e, v);
	mov	dptr,#(_cobs_log_u8_e_10000_47 + 2)
	mov	dpxl,#((_cobs_log_u8_e_10000_47 + 2) >> 16)
	mov	a,@dpx
	mov	r7,a
	...
	mov	dph, r6
	mov	b, r5
;	<workspace>\mcs251\lib\cobs\cobs.c:101: }
	ejmp	_cobs_log_raw
;------------------------------------------------------------
...
;------------------------------------------------------------
;	<workspace>\mcs251\lib\cobs\cobs.c:103: void cobs_log_u16(cobs_enc_t *e, unsigned int v) {
;	-----------------------------------------
...
_cobs_log_u16:
	...
	mov	@dpx,a
;	<workspace>\mcs251\lib\cobs\cobs.c:104: cobs_log_raw(e, (unsigned char)(v & 0xff));
	mov	dptr,#(_cobs_log_u16_e_10000_49 + 2)
	mov	dpxl,#((_cobs_log_u16_e_10000_49 + 2) >> 16)
	mov	a,@dpx
	mov	r7,a
	...
	pop	ar2
	pop	ar3
;	<workspace>\mcs251\lib\cobs\cobs.c:105: cobs_log_raw(e, (unsigned char)((v >> 8) & 0xff));
	mov	dptr,#(_cobs_log_u16_e_10000_49 + 2)
	mov	dpxl,#((_cobs_log_u16_e_10000_49 + 2) >> 16)
	mov	a,@dpx
	mov	r7,a
	...
	mov	dph, r6
	mov	b, r5
;	<workspace>\mcs251\lib\cobs\cobs.c:106: }
	ejmp	_cobs_log_raw
;------------------------------------------------------------
...
;------------------------------------------------------------
;	<workspace>\mcs251\lib\cobs\cobs.c:108: void cobs_log_u32(cobs_enc_t *e, unsigned long v) {
;	-----------------------------------------
...
_cobs_log_u32:
	...
	mov	@dpx,a
;	<workspace>\mcs251\lib\cobs\cobs.c:109: cobs_log_raw(e, (unsigned char)(v & 0xff));
	mov	dptr,#(_cobs_log_u32_e_10000_51 + 2)
	mov	dpxl,#((_cobs_log_u32_e_10000_51 + 2) >> 16)
	mov	a,@dpx
	mov	r7,a
	...
	pop	r14
	pop	r15
;	<workspace>\mcs251\lib\cobs\cobs.c:110: cobs_log_raw(e, (unsigned char)((v >> 8) & 0xff));
	mov	dptr,#(_cobs_log_u32_e_10000_51 + 2)
	mov	dpxl,#((_cobs_log_u32_e_10000_51 + 2) >> 16)
	mov	a,@dpx
	mov	r7,a
	...
	pop	r14
	pop	r15
;	<workspace>\mcs251\lib\cobs\cobs.c:111: cobs_log_raw(e, (unsigned char)((v >> 16) & 0xff));
	mov	dptr,#(_cobs_log_u32_e_10000_51 + 2)
	mov	dpxl,#((_cobs_log_u32_e_10000_51 + 2) >> 16)
	mov	a,@dpx
	mov	r7,a
	...
	pop	r14
	pop	r15
;	<workspace>\mcs251\lib\cobs\cobs.c:112: cobs_log_raw(e, (unsigned char)((v >> 24) & 0xff));
	mov	dptr,#(_cobs_log_u32_e_10000_51 + 2)
	mov	dpxl,#((_cobs_log_u32_e_10000_51 + 2) >> 16)
	mov	a,@dpx
	mov	r7,a
	...
	mov	dph, r6
	mov	b, r5
;	<workspace>\mcs251\lib\cobs\cobs.c:113: }
	ejmp	_cobs_log_raw
;------------------------------------------------------------
...
;------------------------------------------------------------
;	<workspace>\mcs251\lib\cobs\cobs.c:115: void cobs_log_var(cobs_enc_t *e, unsigned int v) {
;	-----------------------------------------
...
_cobs_log_var:
	...
	mov	@dpx,a
00105$:
;	<workspace>\mcs251\lib\cobs\cobs.c:117: unsigned char b = (unsigned char)(v & 0x7f);
	...
	mov	@dpx,a
;	<workspace>\mcs251\lib\cobs\cobs.c:118: v >>= 7;
	mov	a,r6
	mov	c,acc.7
	xch	a,r7
	rlc	a
	...
	mov	dpxl,#(_cobs_log_var_PARM_2 >> 16)
	mov	@dpx,a
;	<workspace>\mcs251\lib\cobs\cobs.c:119: if (v != 0) {
	mov	dptr,#(_cobs_log_var_PARM_2 + 1)
	mov	dpxl,#((_cobs_log_var_PARM_2 + 1) >> 16)
	mov	a,@dpx
	mov	b,a
	...
	ejmp	00102$
00123$:
;	<workspace>\mcs251\lib\cobs\cobs.c:120: cobs_log_raw(e, (unsigned char)(b | 0x80));
	mov	dptr,#(_cobs_log_var_e_10000_53 + 2)
	mov	dpxl,#((_cobs_log_var_e_10000_53 + 2) >> 16)
	mov	a,@dpx
	mov	r7,a
	...
	ejmp	00105$
00102$:
;	<workspace>\mcs251\lib\cobs\cobs.c:122: cobs_log_raw(e, b);
	mov	dptr,#(_cobs_log_var_e_10000_53 + 2)
	mov	dpxl,#((_cobs_log_var_e_10000_53 + 2) >> 16)
	mov	a,@dpx
	mov	r7,a
	...
	mov	dph, r6
	mov	b, r5
;	<workspace>\mcs251\lib\cobs\cobs.c:123: return;
;	<workspace>\mcs251\lib\cobs\cobs.c:126: }
	ejmp	_cobs_log_raw
;------------------------------------------------------------
...
;------------------------------------------------------------
;	<workspace>\mcs251\lib\cobs\cobs.c:128: void cobs_log_bytes(cobs_enc_t *e, const unsigned char *p, unsigned int n) {
;	-----------------------------------------
...
_cobs_log_bytes:
	...
	mov	@dpx,a
;	<workspace>\mcs251\lib\cobs\cobs.c:130: cobs_log_var(e, n);
	mov	dptr,#(_cobs_log_bytes_e_10000_60 + 2)
	mov	dpxl,#((_cobs_log_bytes_e_10000_60 + 2) >> 16)
	mov	a,@dpx
	mov	r7,a
	...
	pop	ar2
	pop	ar3
;	<workspace>\mcs251\lib\cobs\cobs.c:131: for (i = 0; i < n; i++) cobs_log_raw(e, p[i]);
...
00123$:
	...
	ejmp	00103$
00105$:
;	<workspace>\mcs251\lib\cobs\cobs.c:132: }
	eret
;------------------------------------------------------------
...
;------------------------------------------------------------
;	<workspace>\mcs251\lib\cobs\cobs.c:134: void cobs_log_str(cobs_enc_t *e, const char *s) {
;	-----------------------------------------
...
_cobs_log_str:
	...
	mov	@dpx,a
;	<workspace>\mcs251\lib\cobs\cobs.c:136: while (s[n] != '\0') n++;
...
00140$:
	ejmp	00101$
00103$:
;	<workspace>\mcs251\lib\cobs\cobs.c:137: cobs_log_var(e, n);
	mov	dptr,#(_cobs_log_str_e_10000_63 + 2)
	mov	dpxl,#((_cobs_log_str_e_10000_63 + 2) >> 16)
	mov	a,@dpx
	mov	r4,a
	...
	pop	ar6
	pop	ar7
;	<workspace>\mcs251\lib\cobs\cobs.c:138: while (*s != '\0') cobs_log_raw(e, (unsigned char)*s++);
00104$:
	mov	dpl,r7
	mov	dph,r6
	mov	dpxl,r5
...
00142$:
	...
	ejmp	00104$
00107$:
;	<workspace>\mcs251\lib\cobs\cobs.c:139: }
	eret
;------------------------------------------------------------
...
;------------------------------------------------------------
;	<workspace>\mcs251\lib\cobs\cobs.c:141: unsigned int cobs_log_end(cobs_enc_t *e) {
;	-----------------------------------------
...
_cobs_log_end:
	...
	mov	@dpx,a
;	<workspace>\mcs251\lib\cobs\cobs.c:142: cobs_log_raw(e, e->ck);
	mov	dptr,#(_cobs_log_end_e_10000_65 + 2)
	mov	dpxl,#((_cobs_log_end_e_10000_65 + 2) >> 16)
	mov	a,@dpx
	mov	r7,a
	...
	mov	b, r5
	ecall	_cobs_log_raw
;	<workspace>\mcs251\lib\cobs\cobs.c:143: return cobs_finish(e);
	mov	dptr,#(_cobs_log_end_e_10000_65 + 2)
	mov	dpxl,#((_cobs_log_end_e_10000_65 + 2) >> 16)
	mov	a,@dpx
	mov	r7,a
	...
	mov	dph, r6
	mov	b, r5
;	<workspace>\mcs251\lib\cobs\cobs.c:144: }
	ejmp	_cobs_finish
	.area CSEG    (CODE)
	.area CONST   (CODE)
	.area XINIT   (CODE)
